...
class VanillaBaselineResponseHandler(ResponseHandler):
    def __init__(self):
        super().__init__()
        self.desc = ""
        self.reason = ""
...
class VanillaBaselinePromptGenerator(PromptGenerator):
    ...
    def get_prompt(
        ...
        task: GenerationTask,
        problem_desc: str,
        candidates: list[VanillaBaselineResponseHandler] = None,
...
"""
    ...
    def __get_candidate_prompt(self, candidate: VanillaBaselineResponseHandler) -> str:
...
"""
    ...
    def get_response_handler(self):
        return VanillaBaselineResponseHandler()
